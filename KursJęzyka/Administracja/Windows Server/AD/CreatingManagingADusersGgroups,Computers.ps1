...
$NewUserHT.UserPrincipalName = 'jerryg@domena.com'
...
$NewUserHT.UserPrincipalName = 'tbr@domena.com'
$NewUserHT.Name              = 'TBR1'
...
$NewUserHT.UserPrincipalName  = 'tbr2@domena.com'
$NewUserHT.Name               = 'TBR2'
New-ADUser @NewUserHT
...
$TLHT =@{
  ...
  Office       = 'Marin Office'
  EmailAddress = 'ThomasL@domena.com'
  GivenName    = 'Thomas'
  Surname      = 'Lee' 
