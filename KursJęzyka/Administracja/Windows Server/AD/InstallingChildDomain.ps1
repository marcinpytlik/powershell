...
# 2. Check DC1 can be resolved and  can be reached over 445 and 389 
...
# 5. Look at AD forest
Get-ADForest -Server dc1.poddomena.domena.com

# 6. Look at UK domain
Get-ADDomain -Server dc1.poddomena.domena.com
