...
Add-DhcpServerInDC -DnsName DC2.domena.com
...
Invoke-Command -ComputerName DC1.domena.com -ScriptBlock {
  Add-DhcpServerv4Failover @Using:FAILOVERHT  
}

# 6. Get active leases in the scope (from both servers!)
$DHCPServers = 'DC1.domena.com', 'DC2.domena.com' 
$DHCPServers |   
  ForEach-Object { 
