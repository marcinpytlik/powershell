...
Get-DhcpServerv4Scope -ComputerName DC1.domena.com

# 3. Set Server Wide Option Values
$OPTION1HT = @{
  ComputerName = 'DC1.domena.com' # DHCP Server to Configure
  DnsDomain    = 'domena.com'     # Client DNS Domain
...
Resolve-DnsName -Name SRV2.domena.com -Type A
