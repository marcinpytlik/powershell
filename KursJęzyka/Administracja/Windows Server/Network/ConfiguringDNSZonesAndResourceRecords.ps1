...
$ZHT2 = @{
  ...
  ResponsiblePerson = 'dnsadmin.domena.com.' 
  ReplicationScope  = 'Forest'
  ComputerName      = 'DC1.domena.com'
}
...
# Test The Cname
Resolve-DnsName -Server DC1.domena.com -Name 'Mail.Cookham.Net'
# Test The MX on DC2
Resolve-DnsName -Server DC2.domena.com -Name 'Cookham.Net'  -Type MX 
