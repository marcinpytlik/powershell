...
Test-NetConnection -ComputerName DC1.domena.com |
  Format-Table
# Test the DNS server on DC1.domena.com correctly resolves 
# the A record for SRV2.
Resolve-DnsName -Name SRV2.domena.com -Server DC1.domena.com -Type 'A'
