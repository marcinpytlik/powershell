...
$CascadiaFile   = "C:\installps7\$CascadiaFont"
...
$ShortcutLocation    = "C:\installps7\vscode.lnk"
...
$ShortcutLocation    = 'C:\installps7\pwsh.lnk'
# Create a  new wscript.shell object
$WScriptShell        = New-Object -ComObject WScript.Shell
$Shortcut            = $WScriptShell.CreateShortcut($ShortcutLocation)
$Shortcut.TargetPath = $SourceFileLocation
...
<taskbar:TaskbarPinList>
 <taskbar:DesktopApp DesktopApplicationLinkPath="C:\installps7\vscode.lnk" />
 <taskbar:DesktopApp DesktopApplicationLinkPath="C:\installps7\pwsh.lnk" />
</taskbar:TaskbarPinList>
</defaultlayout:TaskbarLayout>
</CustomTaskbarLayoutCollection>
</LayoutModificationTemplate>
'@
$XML | Out-File -FilePath C:\installps7\Layout.Xml

# 10. Import the  start layout XML file
#     You get an error if this is not run in an elevated session
Import-StartLayout -LayoutPath C:\installps7\Layout.Xml -MountPath C:\
